...
&emsp;&emsp;&emsp; (2) 已知$\sin\theta+\cos\theta=\frac{1-\sqrt{3}}{2}$，求$\sin 2\theta$的值.  
...
&emsp;&emsp;4. 已知$\sin\alpha=\frac{2\sqrt{5}}{5}$，$\alpha$是第二象限角，且$\tan(\alpha+\beta)=1$，求$\tan\beta$的值.  
...
&emsp;&emsp;(1) 求证：$\tan\frac{A}{2}\tan\frac{B}{2}+\tan\frac{B}{2}\tan\frac{C}{2}+\tan\frac{C}{2}\tan\frac{A}{2}=1$；  
