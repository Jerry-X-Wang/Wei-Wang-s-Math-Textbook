...
&emsp;&emsp;1. 求下列各式的值：
<font style="line-height: 2.5">&emsp;&emsp;(1) $\displaystyle \sin\frac{\pi}{8}\cos\frac{\pi}{8}$；  
&emsp;&emsp;(2) $\displaystyle \sin^{2}\frac{\pi}{12}-\cos^{2}\frac{\pi}{12}$；  
&emsp;&emsp;(3) $\displaystyle \sin^{2}\frac{\pi}{12}-\frac{1}{2}$；  
&emsp;&emsp;(4) $\displaystyle \frac{\sin15\degree-\cos15\degree}{\sin15\degree+\cos15\degree}$.</font>
